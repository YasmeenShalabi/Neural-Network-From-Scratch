...
#Mean Squared Error(MSE) Loss Function to measure model performance
...
class BasicNeuralNetwork:
    ...
    def backward(self, X, y, output, learning_rate):
        ...
        hidden_error= np.dot(output_delta, self.weights_hidden_output.T) #error for hidden layer, propogated from output layer
